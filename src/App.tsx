      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="flex-1">
          ...
          <div className="animate-in fade-in duration-1000">
            ...
            <footer className="px-10 py-16 bg-[var(--color-natural-light)] border-t border-[var(--color-natural-border)]/30 text-center relative z-20 flex flex-col items-center justify-center">
              <p className="text-xs font-sans opacity-60 tracking-widest uppercase mb-6">
                Designed with love by Dad
              </p>
              
              <div className="max-w-md mx-auto bg-white/60 p-6 rounded-2xl border border-[var(--color-natural-border)]/40 shadow-sm">
                <p className="text-sm font-light text-[var(--color-natural-text)]/80 mb-4 leading-relaxed">
